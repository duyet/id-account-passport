...
<?php if( $_GET['id'] == 'ie8' ) { ?>
	form#gaia_loginform input#Email, form#gaia_loginform input#Passwd, input.textbox{
	...
	form#gaia_loginform input#Email:hover, form#gaia_loginform input#Passwd:hover, input.textbox:hover{
  border: 1px solid #b9b9b9;
  border-top: 1px solid #a0a0a0;
  -webkit-box-shadow: inset 0 1px 2px rgba(0,0,0,0.1);
  -moz-box-shadow: inset 0 1px 2px rgba(0,0,0,0.1);
  ...
  form#gaia_loginform input#Email:focus, form#gaia_loginform input#Passwd:focus, input.textbox:focus {
  outline: none;
...
form#gaia_loginform input#Email[disabled=disabled] {
  border: 1px solid #e5e5e5;
  background: #f5f5f5;
  }
  
  form#gaia_loginform input#PersistentCookie{
  ...
  form#gaia_loginform input#PersistentCookie:active{
  border-color: #c6c6c6;
  background: #ebebeb;
  }
   form#gaia_loginform input#PersistentCookie:hover {
  border-color: #c6c6c6;
  -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,0.1);
  -moz-box-shadow: inset 0 1px 1px rgba(0,0,0,0.1);
  box-shadow: inset 0 1px 1px rgba(0,0,0,0.1);
  }
  input.g-button-reset{
  .g-button {
  display: inline-block;
  min-width: 46px;
  text-align: center;
  ...
  form#gaia_loginform input#signIn, input.g-button-submit {
  display: inline-block;
  min-width: 46px;
  text-align: center;
  color: #444;
  ...
  input.g-button:hover, input.g-button-submit:hover{
 ...
 form#gaia_loginform input#signIn:active, input.g-button-submit:active {
  ...
  form#gaia_loginform input#signIn:visited, input.g-button-submit:visited {
  color: #666;
  }
  div.google-footer-bar .footer{
  position: absolute;
  bottom: 0;
  height: 35px;
  width: 100%;
  ...
  div.google-footer-bar .footer ul li{
   display: inline;
   padding: 0 1.5em 0 0;
  }
  div.google-footer-bar .footer ul li a{
  padding-top: 9px;
  font-size: 1em;
  white-space: nowrap;
  line-height: 0;
  ...
  input.g-button-submit:focus{
  -webkit-box-shadow: inset 0 0 0 1px #fff;
  -moz-box-shadow: inset 0 0 0 1px #fff;
  box-shadow: inset 0 0 0 1px #fff;
  }
.form_register form div.fiel{
	margin-left: 20px;
	margin-top: 2px;
	padding:5px 10px 5px 10px;
}
.form_register form div.fiel label{

}
form div.fiel .rightcol{
	margin-left:130px;
	max-width:496px;
	*margin-left:0;
	float:none;
...
form div.fiel .rightcol .statusbox #checkusernamestatusfail, 
form div.fiel .rightcol .statusbox #checkusernamestatusok{
	float:right;
}

.form_register form div.fiel .rightcol ul li{
	padding-left: 180px;
}
...
die; 
  ...
  *:first-child+html .clearfix {
  ...
  content: url(header_files/checkmark.png);
  display: block;
  position: absolute;
  top: -6px;
  left: -5px;
  ...
  *:first-child+html .goog-inline-block {
  ...
  background: url(header_files/grey-disclosure-arrow-up-down.png) center no-repeat;
  border: none;
  height: 11px;
  margin-top: -4px;
  width: 7px;
  ...
  height: 19px;
  width: 52px;
  background: transparent url(header_files/google-signin-flat.png) no-repeat;
  }
  .signin-box label {
  display: block;
  margin: 0 0 1.5em;
  ...
  .product-info ul.default li {
  list-style-type: disc;
  margin-left: 3em;
  }
  .product-info .notification-bar {
  margin-bottom: 1em;
  }
  .product-info .notification-bar p span {
  color: #dd4b39;
  }
  ...
  margin-top: 20px;
  margin-bottom: 15px;
  text-shadow: 1px 1px 1px rgb(13, 148, 232);
  -webkit-text-shadow: 1px 1px 1px rgb(13, 148, 232);
  -moz-text-shadow: 1px 1px 1px rgb(13, 148, 232);
 }
.ID_port span.text{
  font-weight: 900;
  font-size: 150%;
...
table.infousertable tr td.left{
	border-right: 1px solid black;
}
table.infousertable tr td.right{
	
}
table.infousertable table{
	width:100%;
}
table.infousertable table {
	font-size: 14px;
...
table.infousertable table tr td {
	padding: 10px;
}
table.infousertable table tr td.key {
	text-align: right;
	width: 40%;
	
	color: #6D6D6D;
}
table.infousertable table tr td.val {
	color: #1800F7;
	font-weight: bold;
}
...
.form_register form div.fiel .description {
	color:#777777;
	font-size:11px;
	max-width:496px;
	margin-left:212px;
...
.form_register form div.fiel input.textbox{
	width: 300px;
	margin-left: 6px;
}
hr.blue{
...
div#passwordconfirmstatusfail, div#emailconfirmstatusfail, div#checkusernamestatusfail{
...
div#passwordconfirmstatusok, div#emailconfirmstatusok, div#checkusernamestatusok{
...
.lostpass-table tr td.left{
	width: 30%;
}

.lostpass-table tr td input.textbox{
	width: 400px;
}

.lostpass-table tr td .text{
	overflow: hidden;
	 margin: 2em 0 0;
	 margin: 0 0 0 68px;
	 font-size: 14px;
	...
	.infousertable {width: 900px;}
	.info_fiel{width: 250px; }
	.infousertable .password_again{}
	.infousertable .birthday{width:200px;text-align:center}
	.infousertable .help{font-weight: bold; color: red; padding-left: 10px;}
	.infousertable .help_box{width: 250px; float: right;}
	.infousertable .userid, .infousertable .usergroupid, .infousertable .posts, .infousertable .styleid{width: 45px; text-align: center;}
	.infousertable .lemon9x_left{width:480px; float: left;}
...
.contact table tr td table tr td input.textbox{
	width: 345px;
}
.contact table tr td table tr td textarea{
	width: 525px;
	height: 178px;
	margin: 0;
	padding: 1px;
