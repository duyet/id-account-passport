...
?>
<div class="reg_error"><?= $yplitgroupRegisterError ?></div>
<?php } ?>
<div class="form_register">
	<form method="POST" action="./index.php?do=register&amp;p=addmember" onSubmit="if( yplitgroupCheckAllFiels() == false ) { return false; } else { return true; }">
	<input type="hidden" name="return" value="<?=  ( !empty( $param['return'] ) ? urlencode( $param['return'] ) : '' ) ?>">
		...
		<?php } ?>
		<div class="rightcol">
			<input type="reset" class="g-button g-button-reset" value="<?= $lang['reset_button'] ?>">
			&nbsp;&nbsp;&middot;&nbsp;&nbsp;
			<input type="submit" name="submit" class="g-button g-button-submit"  value="<?= $lang['register_button'] ?>">
		</div>
	</form>
</div>
<script>
